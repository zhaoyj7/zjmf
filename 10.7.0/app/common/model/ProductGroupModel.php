...
class ProductGroupModel extends Model
{
    ...
    public function productGroupSecondList($param)
    {
        ...
        $group = $this->alias('pg')->field('pg.id,pg.name,pg.parent_id,pg.hidden,pg.type,pg.description')
    ...
    public function createProductGroup($param)
    {
        ...
        try{
            $productGroup = $this->create([
                ...
                "type" => $param['type']??"",
                'description' => $param['id'] > 0 ? ($param['description'] ?? '') : '',
            ]);
    ...
    public function updateProductGroup($param)
    {
        ...
        try{
            $productGroup->save([
                ...
                'description' => $productGroup['parent_id'] > 0 ? ($param['description'] ?? '') : '',
                'update_time' => time()
            ]);
