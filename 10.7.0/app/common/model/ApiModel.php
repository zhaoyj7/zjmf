...
class ApiModel extends Model
{
     ...
     * @return string data.api_url - API接口地址
     */
    public function createApi($param)
    {
        ...
        return ['status' => 200, 'msg' => lang('create_success'), 'data' => ['name' => $param['name'] ?? '', 'id' => $api->id, 'token' => $token, 'private_key' => $res['private_key'], 'create_time' => $api->create_time, 'api_url'=>$apiUrl ]];
    }
