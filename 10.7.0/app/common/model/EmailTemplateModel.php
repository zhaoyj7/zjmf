...
class EmailTemplateModel extends Model
{
    ...
    public function emailTemplateList()
    {
    	...
    	$count = $this->field('id')
		    ->count();
    	$emailTemplates = $this->field('id,name,subject,notice_setting_name')
    		->select()
            ->toArray(); 
     ...
     * @return string notice_setting_name - 默认动作名称
     */
    public function indexEmailTemplate($id)
    {
        $emailTemplate = $this->field('id,name,subject,message,notice_setting_name')->find($id);
     ...
     * @param string param.notice_setting_name - 默认动作名称
    ...
    public function createEmailTemplate($param)
    {
		...
		try {
	    	$email_id = $emailTemplate = $this->create([
	    		...
	    		'attachment' => '',
                'create_time' => time(),
                'notice_setting_name' => $param['notice_setting_name']??''
	    	]);
