...
class SmsTemplateModel extends Model
{
    ...
    {
        $sms_template = $this->field('id,template_id,type,title,content,notes,status,sms_name,product_url,remark,notice_setting_name')
		->where('sms_name',$name)
		->select()
		->toArray();		
    ...
    {
        $sms_template = $this->field('id,template_id,type,title,content,notes,status,product_url,remark,notice_setting_name')
		->where('id',$param['id'])
    ...
    public function createSmsTemplate($param)
    {
        ...
        try {
            $sms_id =$this->create([
                ...
                'notice_setting_name' => isset($param['notice_setting_name']) ? trim($param['notice_setting_name']) : '',
                'create_time' => time()
            ]);
			//日志
