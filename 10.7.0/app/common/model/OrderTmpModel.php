    ...
    public function credit($param)
    {
        ...
        if (!$use){
            ...
            try{
                ...
                if ($client->credit <= 0){
                    $this->rollback();
                    return ['status'=>400,'msg'=>lang('client_credit_is_0'),'data'=>['no_credit'=>1,'id'=>$id,'customfields'=>$customfields,'amount'=>$order['amount']]];
//                    throw new \Exception(lang('client_credit_is_0'));
            ...
            return ['status'=>200,'msg'=>lang('success_message'),'data'=>['id'=>$id,'customfields'=>$customfields,'amount'=>$order['amount']]];
        }
    }
