...
class BottomBarNavModel extends Model
{
    ...
    public function navList($param)
    {
        ...
        $list = $this->field('id,group_id,name,url,show,blank')
            ->where('theme', $theme)
    ...
    public function updateNav($param)
    {
        ...
        try {
            ...
            $desc = [
                ...
                'blank'         => lang('bottom_bar_nav_blank'),
            ];
     ...
     */
    public function webFooterNav($language='zh-cn')
    {
        $theme = configuration('web_theme');

        $list = $this->field('id,group_id,name,url,blank')
            ->where('show', 1)
            ->where('theme', $theme)
