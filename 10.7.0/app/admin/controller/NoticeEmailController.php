...
class NoticeEmailController extends AdminBaseController
{
     ...
     * @author theworld
     * @version v1
     * @return array list - desc:邮件模板列表
     * @return int list[].id - desc:邮件模板ID
     * @return string list[].name - desc:名称
     * @return string list[].subject - desc:标题
     * @return int count - desc:邮件模板总数
     */
     ...
     * @return object email_template - desc:邮件模板
     * @return int email_template.id - desc:邮件模板ID
     * @return string email_template.name - desc:名称
     * @return string email_template.subject - desc:标题
     * @return string email_template.message - desc:内容
     */
     ...
     * @param string subject - desc:标题 validate:required
     * @param string message - desc:内容 validate:required
     ...
     * @author theworld
     * @version v1
     * @param string name - desc:邮件接口标识名称 validate:required
     * @param int id - desc:邮件模板ID validate:required
