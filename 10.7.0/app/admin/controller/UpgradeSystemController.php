...
class UpgradeSystemController extends AdminBaseController
{
     ...
     * @method GET
     * @return string version - desc:当前系统版本
     * @return string last_version - desc:最新系统版本
     * @return string last_version_check - desc:最新系统版本检测结果
     * @return int is_download - desc:更新包是否下载完毕 0否 1是
     * @return string license - desc:授权码
     * @return string service_due_time - desc:服务到期时间
     * @return string due_time - desc:授权到期时间
     * @return string system_version_type - desc:系统升级版本 beta内测版 stable正式版
     * @return string system_version_type_last - desc:最后一次系统升级版本 beta内测版 stable正式版
     * @return int expire - desc:是否即将到期 0未到期 1即将到期 2已到期
     */
     ...
     * @method PUT
     * @param string system_version_type - desc:系统升级版本 beta内测版 stable正式版 validate:required
     */
     ...
     * @method GET
     * @return string warning - desc:必读内容
     * @return string content - desc:更新内容
     */
     ...
     * @method GET
     * @return string progress - desc:下载百分比
     * @return string moment_size - desc:已下载大小 MB
     * @return string origin_size - desc:文件总大小 MB
     */
     ...
     * @method PUT
     * @param string license - desc:授权码 validate:required
     */
