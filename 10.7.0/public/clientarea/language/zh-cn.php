...
return [
    ...
    'log_client_login' => '{client}登录系统，登录方式：{type}',
    ...
    'login_type_phone_code' => '手机验证码登录',
    'login_type_email_password' => '邮箱密码登录',
    'login_type_phone_password' => '手机密码登录',

    // 安全验证相关
    'login_ip_exception_need_verify' => '检测到异常登录，请完成安全验证',
    'security_verify_operate_password' => '操作密码',
    'security_verify_email_code' => '邮箱验证码',
    'security_verify_phone_code' => '手机验证码',
    'security_verify_certification' => '实名校验',
    'security_verify_send_to' => '发送至 {account}',
    'security_verify_certification_tip' => '使用支付宝扫码验证',
    'security_verify_certification_tip_wechat' => '使用微信扫码验证',
    'security_verify_certification_tip_other' => '请扫码验证',
    'security_verify_method_invalid' => '验证方式无效',
    'security_verify_required' => '请先完成安全验证',
    'operate_password_required' => '请输入操作密码',
    'verification_code_required' => '请输入验证码',
    'certify_id_required' => '缺少认证ID',
    'certification_not_passed' => '实名认证未通过',
    'client_not_certified' => '您尚未实名认证，请先完成实名认证',
    'client_already_certified' => '您已完成实名认证',
    'certification_plugin_not_installed' => '实名认证插件未安装',
    'certification_create_failed' => '创建实名认证失败',
    'certification_expired' => '实名认证已过期，请重新发起',
    'certification_pending' => '实名认证待验证',
    'certification_query_failed' => '查询实名认证状态失败',
    'log_client_login_security_verify_success' => '{client}通过{method}完成安全验证登录',
    'log_client_security_verify_operate_password_error' => '{client}安全验证操作密码错误',
    'log_client_security_verify_operate_password_success' => '{client}安全验证操作密码成功',
    'log_client_security_verify_code_success' => '{client}通过{method}完成安全验证',
    'log_client_security_verify_certification_success' => '{client}通过实名认证完成安全验证',
    'verification_code_expired' => '验证码已过期',
    'verification_code_error' => '验证码错误',
    'operate_password_not_set' => '您尚未设置操作密码',

    'login_type_oauth' => '三方登录',
    'certification_security_verify_default' => '请安装官方‘智简魔方-芝麻信用’实名接口',
];
