  ...
  window.onload = function () {
    ...
    new Vue({
        ...
        return {
          ...
          relationRules: {
            host_id: [
              {
                required: true,
                message: `${lang.placeholder_pre2}${lang.cloud_menu_1}`,
                trigger: "change",
              },
            ],
          },
      ...
      methods: {
        ...
        batchDelete() {
          if (this.multipleSelection.length === 0) {
            return this.$message.warning(
              `${lang.placeholder_pre2}${lang.rules}`
            );
          }
          this.delType = "batch";
        ...
        chooseAll(val) {
          this.relationForm.host_id = val
            ? this.availableCloud.map((item) => item.id)
            : [];
        },
        submitRelation() {
        ...
        getCommonData() {
          ...
          document.title =
            this.commonData.website_name + "-" + lang.security_group;
        },
      },
    }).$mount(template);
