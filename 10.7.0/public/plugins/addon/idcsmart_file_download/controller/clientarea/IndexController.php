...
class IndexController extends PluginBaseController
{
     ...
     * @method GET
     * @return array list - desc:文件夹列表
     * @return int list[].id - desc:文件夹ID
     * @return string list[].name - desc:名称
     * @return int list[].default - desc:默认文件夹 0否 1是
     * @return int list[].file_num - desc:文件数量
     * @return int count - desc:全部文件数量
     */
     ...
     * @url /console/v1/file
     * @method GET
     * @param int addon_idcsmart_file_folder_id - desc:文件夹ID validate:optional
     * @return array list - desc:文件列表
     * @return int list[].id - desc:文件ID
     * @return string list[].name - desc:名称
     * @return string list[].filetype - desc:文件类型
     * @return string list[].filesize - desc:文件大小
     * @return string list[].create_time - desc:上传时间
     * @return string list[].description - desc:描述
     * @return int count - desc:文件总数
     */
     ...
     * @method GET
     * @param int id - desc:文件ID validate:required
     */
