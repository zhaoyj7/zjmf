...
class PromoCodeValidate extends Validate
{
	protected $rule = [
		...
		'flow_packet'         => 'require|in:0,1',
		'notes'               => 'max:1000',
        'status'              => 'require|in:0,1',
        'exclude_with_client_level' => 'require|in:0,1',
    ...
    protected $message  =   [
        ...
        'flow_packet.require'           => 'param_error',
        'flow_packet.in'                => 'param_error',
        'notes.max'                     => 'promo_code_notes_max',
        'status.require'                => 'param_error',
        'status.in'                     => 'param_error',
        'exclude_with_client_level.require' => 'param_error',
        'exclude_with_client_level.in'      => 'param_error',
    ...
    protected $scene = [
        'create' => ['code','type','client_type','client_level','start_time','end_time','products','need_products','max_times','single_user_once','upgrade','host_upgrade','renew','loop','cycle_limit','cycle'/*,'flow_packet'*/,'notes','on_demand_to_recurring_prepayment','exclude_with_client_level'],
        'update' => ['id','client_type','client_level','start_time','end_time','products','need_products','max_times','single_user_once','upgrade','host_upgrade','renew','loop','cycle_limit','cycle'/*,'flow_packet'*/,'notes','on_demand_to_recurring_prepayment','exclude_with_client_level'],
        'status' => ['status'],
