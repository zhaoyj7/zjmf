...
return [
    ...
    'promo_code_type_percent_description' => '优惠码{promo_code}应用至{target}, {value}% 百分比 折扣',
    'promo_code_type_fixed_amount_description' => '优惠码{promo_code}应用至{target}, {value} 固定金额减免 折扣',
    'promo_code_type_replace_price_description' => '优惠码{promo_code}应用至{target}, {value} 覆盖价格 折扣',
    'promo_code_type_free_description' => '优惠码{promo_code}应用至{target}, 免费 折扣',
    ...
    'addon_promo_code_host' => '产品Host Id:{host_id}',
    ...
    'addon_promo_code_flow_packet_cannot_use' => '该优惠码无法用于流量包订单',
    ...
    'promo_code_flow_packet_desc' => '开启后该优惠码可用于流量包订单',

    # 不与用户等级同享
    'promo_code_exclude_with_client_level' => '不与用户等级同享',
    'promo_code_exclude_with_client_level_desc' => '开启后使用优惠码时不与用户等级折扣叠加',
