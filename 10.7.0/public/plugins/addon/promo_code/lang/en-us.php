...
return [
	...
	'promo_code_type_percent_description' => 'Discount code {promo_code} applied to {target}, {value}% percentage discount',
	'promo_code_type_fixed_amount_description' => 'Discount code {promo_code} applied to {target}, {value} fixed amount reduction discount',
	'promo_code_type_replace_price_description' => 'Discount code {promo_code} applied to {target}, {value} override price discount',
	'promo_code_type_free_description' => 'Discount code {promo_code} applied to {target}, free discount',
	...
	'addon_promo_code_flow_packet' => 'flow packet',
	'addon_promo_code_host' => 'product Host Id:{host_id}',
	...
	'addon_promo_code_flow_packet_cannot_use' => 'This promo code cannot be used for flow packet orders',
	...
	# Flow packet related
	'promo_code_flow_packet' => 'Flow Packet Usage',
	'promo_code_flow_packet_desc' => 'When enabled, this promo code can be used for flow packet orders',

	# Exclude with client level
	'promo_code_exclude_with_client_level' => 'Exclude with Client Level',
	'promo_code_exclude_with_client_level_desc' => 'When enabled, the promo code discount will not stack with client level discount',
