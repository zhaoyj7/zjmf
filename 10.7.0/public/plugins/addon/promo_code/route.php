...
Route::group('console/v1',function (){
    ...
    # 批量应用优惠码
    Route::post('promo_code/apply_batch', "\\addon\\promo_code\\controller\\clientarea\\IndexController@applyBatch")
        ->append(['_plugin'=>'promo_code','_controller'=>'index','_action'=>'applyBatch']);
})
    ->allowCrossDomain([
        'Access-Control-Allow-Origin'        => $origin,
        'Access-Control-Allow-Credentials'   => 'true',
