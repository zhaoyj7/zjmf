...
class PromoCode extends Plugin
{
  ...
  `flow_packet` tinyint(1) NOT NULL DEFAULT '0' COMMENT '流量包使用0关闭1开启',
  ...
  `on_demand_to_recurring_prepayment` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '按需转包年包月优惠(0=关闭,1=开启)',
  `exclude_with_client_level` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '不与用户等级同享(0=关闭,1=开启)',
  ...
  KEY `client_id` (`client_id`)
    ...
    public function upgrade()
    {
        ...
        if(isset($plugin['version'])){
            ...
            if(version_compare('3.0.4', $plugin['version'], '>')){
