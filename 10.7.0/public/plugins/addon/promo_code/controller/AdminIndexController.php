...
class AdminIndexController extends PluginAdminBaseController
{
     ...
     * @return int promo_code.flow_packet - 流量包使用:0关闭,1开启
     * @return int promo_code.exclude_with_client_level - 不与用户等级同享:0关闭,1开启
     */
     ...
     * @param int flow_packet - 流量包使用:0关闭,1开启 required
     ...
     * @param int exclude_with_client_level - 不与用户等级同享:0关闭,1开启 required
     */
