const plugin_lang = {
  ...
  credit_withdrawal: "Withdraw Balance",

  page_total_apply_amount: "Total of all application amounts on this page",
  total_apply_amount: "Total of all application amounts",
};
