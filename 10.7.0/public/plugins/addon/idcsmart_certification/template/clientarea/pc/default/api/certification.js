...
// 实名认证接口配置
function apiCertificationConfig(params) {
  return Axios.get(`/certification/plugin/config`, { params });
}

// 生成实名认证订单
function apiCertificationOrder(params) {
  return Axios.post(`/certification/plugin/order`, params);
}
