...
class CertificationController extends PluginBaseController
{
     ...
     * @return int certification_company_need_person - 企业认证需先完成个人认证:1是,0否默认
     */
     ...
     * @param int certification_company_need_person - 企业认证需先完成个人认证:1是,0否默认 required
     */
    public function setConfig()
    {
        $param = $this->request->only(['certification_open', 'certification_company_open','certification_approval', 'certification_notice' ,'certification_update_client_name',
            ...
            'certification_recharge', 'certification_show_certify_id', 'certification_company_need_person']);
     ...
     * @title 获取实名认证
     * @desc 获取实名认证
     * @url /admin/v1/certification/client/:client_id
     * @method  GET
     * @author wyh
     * @version v1
    ...
    public function indexClient()
    {
        ...
        $id = $CertificationLogModel->where('client_id',$param['client_id']??0)->order('id','desc')->value('id');
