...
Route::group(DIR_ADMIN . '/v1',function (){
    ...
    Route::get('certification/client/:client_id', "\\addon\\idcsmart_certification\\controller\\CertificationController@indexClient")
        ->append(['_plugin'=>'idcsmart_certification','_controller'=>'certification','_action'=>'index_client']);
