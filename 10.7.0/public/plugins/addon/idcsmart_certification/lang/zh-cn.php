...
return [
    ...
    'certification_company_need_person_first' => '请先完成个人实名认证后再进行企业认证',
    'certification_reject_reason_max' => '驳回原因不能超过255个字',
    'idcsmart_certification_apply_notice_send_mail' => '实名认证审核通知发送邮件',
    'idcsmart_certification_apply_notice_send_sms' => '实名认证审核通知发送短信',
    ...
    'field_idcsmart_certification_certification_company_need_person' => '企业认证需先完成个人认证',
