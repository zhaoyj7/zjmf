(function () {
  const plugin_lang = {
    "zh-cn": {
      ...
      // 引用回复相关
      quote_reply_label: "回复",
      quote_goto_original: "跳转到原消息",
      quote_reply_button: "引用回复",
      quote_reply_title: "正在引用回复",
      ticket_empty: "没有新的工单需要处理",
    },
    "en-us": {
      all: "all",
      type: "type",
      ...
      // Quote reply related
      quote_reply_label: "Reply",
      quote_goto_original: "Go to original message",
      quote_reply_button: "Quote Reply",
      quote_reply_title: "Replying with quote",
      ticket_empty: "No new tickets need to be processed",
    },
    "zh-hk": {
      all: "全部",
      type: "類型",
      ...
      // 引用回覆相關
      quote_reply_label: "回覆",
      quote_goto_original: "跳轉到原訊息",
      quote_reply_button: "引用回覆",
      quote_reply_title: "正在引用回覆",
      ticket_empty: "沒有新的工單需要處理",
    },
  };
