    ...
    new Vue({
      ...
      methods: {
        ...
        replyItem(item) {
          ...
          // 滚动到输入框位置
          this.$nextTick(() => {
            const inputBox = this.$refs.comTinymce.$el;
        ...
        getQuotedItemAttachments(quoteId) {
          ...
          const quotedItem = this.replyList.find((item) => item.id === quoteId);
        ...
        scrollToQuotedMessageById(replyId) {
          ...
          const targetElement = this.$refs.scrollDiv.querySelector(
