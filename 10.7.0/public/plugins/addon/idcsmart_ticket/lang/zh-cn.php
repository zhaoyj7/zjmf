...
return [
    ...
    'ticket_label_about' => '工单相关',
    'ticket_subject_send_param' => '工单标题',
    'ticket_num_send_param' => '工单号',
    'ticket_create_time_send_param' => '工单创建时间',

    # 引用回复相关
    'ticket_quote_reply_not_exist' => '引用的回复不存在',
    'ticket_quote_reply_not_belong' => '引用的回复不属于当前工单',
    'ticket_cannot_close' => '开发者工单不能关闭',
];
