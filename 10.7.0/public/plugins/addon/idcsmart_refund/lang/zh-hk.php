...
return [
    ...
    # 全額退款天數相關
    'refund_full_refund_days' => '全額退款天數',
    'refund_full_refund_days_desc' => '設置購買後X天內可全額退款，0表示不啟用',
    'refund_full_refund_days_unit' => '天',
    'refund_full_refund_days_require' => '請填寫全額退款天數',
    'refund_full_refund_days_integer' => '全額退款天數必須是整數',
    'refund_full_refund_days_egt' => '全額退款天數必須大於等於0',
    'refund_full_refund_days_between' => '全額退款天數必須在0-365之間',
    'refund_in_full_refund_period' => '購買未滿{days}天，可享受全額退款',
    'refund_out_full_refund_period' => '購買已超過{days}天，按{rule}計算退款',
    'refund_full_refund_enabled' => '已啟用{days}天全額退款',
    'refund_full_refund_disabled' => '未啟用全額退款',
    'refund_full_refund_applied' => '{client}在全額退款期內申請退款，全額退還{currency_prefix}{amount}{currency_suffix}',
    'refund_rule_day' => '按天',
    ...
    'refund_cancel_refund_product' => '{admin}取消用戶:{client}的停用申請，停用產品{host}',
    ...
    'refund_module_delete_fail_log' => '產品{host}模块刪除失敗，失敗原因：{reason}',
    ...
    # API開通是否允許退款相關
    'refund_api_refund_allow' => 'API開通是否允許退款',
    'refund_api_refund_allow_desc' => '控制下游代理端請求退款時是否允許',
    'refund_api_refund_not_allow' => '該商品不允許API接口退款',
    'refund_api_refund_allow_yes' => '允許',
    'refund_api_refund_allow_no' => '不允許',
    'refund_api_refund_reject_log' => '代理端{api_name}請求退款被拒絕,商品:{product},產品:{host},原因:該商品不允許API接口退款',
];
