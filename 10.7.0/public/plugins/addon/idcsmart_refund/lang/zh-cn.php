...
return [
    ...
    # 全额退款天数相关
    'refund_full_refund_days' => '全额退款天数',
    'refund_full_refund_days_desc' => '设置购买后X天内可全额退款，0表示不启用',
    'refund_full_refund_days_unit' => '天',
    'refund_full_refund_days_require' => '请填写全额退款天数',
    'refund_full_refund_days_integer' => '全额退款天数必须是整数',
    'refund_full_refund_days_egt' => '全额退款天数必须大于等于0',
    'refund_full_refund_days_between' => '全额退款天数必须在0-365之间',
    'refund_in_full_refund_period' => '购买未满{days}天，可享受全额退款',
    'refund_out_full_refund_period' => '购买已超过{days}天，按{rule}计算退款',
    'refund_full_refund_enabled' => '已启用{days}天全额退款',
    'refund_full_refund_disabled' => '未启用全额退款',
    'refund_full_refund_applied' => '{client}在全额退款期内申请退款，全额退还{currency_prefix}{amount}{currency_suffix}',
    'refund_rule_day' => '按天',
    'refund_rule_month' => '按月',
    'refund_rule_ratio' => '按比例',
    ...
    'refund_cancel_refund_product' => '{admin}取消用户:{client}的停用申请，停用产品{host}',
    ...
    'refund_module_delete_fail_log' => '产品{host}模块删除失败，失败原因：{reason}',
    ...
    # API开通是否允许退款相关
    'refund_api_refund_allow' => 'API开通是否允许退款',
    'refund_api_refund_allow_desc' => '控制下游代理端请求退款时是否允许',
    'refund_api_refund_not_allow' => '该商品不允许API接口退款',
    'refund_api_refund_allow_yes' => '允许',
    'refund_api_refund_allow_no' => '不允许',
    'refund_api_refund_reject_log' => '代理端{api_name}请求退款被拒绝,商品:{product},产品:{host},原因:该商品不允许API接口退款',
];
