...
return [
    ...
    # Full refund days related
    'refund_full_refund_days' => 'Full Refund Days',
    'refund_full_refund_days_desc' => 'Set X days for full refund after purchase, 0 to disable',
    'refund_full_refund_days_unit' => 'Days',
    'refund_full_refund_days_require' => 'Please enter full refund days',
    'refund_full_refund_days_integer' => 'Full refund days must be an integer',
    'refund_full_refund_days_egt' => 'Full refund days must be greater than or equal to 0',
    'refund_full_refund_days_between' => 'Full refund days must be between 0-365',
    'refund_in_full_refund_period' => 'Purchased within {days} days, eligible for full refund',
    'refund_out_full_refund_period' => 'Purchased over {days} days, refund calculated {rule}',
    'refund_full_refund_enabled' => '{days} days full refund enabled',
    'refund_full_refund_disabled' => 'Full refund not enabled',
    'refund_full_refund_applied' => '{client} applied for refund within full refund period, full refund {currency_prefix}{amount}{currency_suffix}',
    'refund_rule_day' => 'by day',
    'refund_rule_month' => 'by month',
    'refund_rule_ratio' => 'by ratio',
    ...
    'refund_cancel_refund_product' => '{admin} Cancel user: {client} deactivation request,deactivation host {host}',
    ...
    'refund_module_delete_fail_log' => 'Product {host} Failed to delete module: {reason}',
    ...
    # API refund allow related
    'refund_api_refund_allow' => 'API Refund Allow',
    'refund_api_refund_allow_desc' => 'Control whether downstream agents can request refunds',
    'refund_api_refund_not_allow' => 'This product does not allow API refund',
    'refund_api_refund_allow_yes' => 'Allow',
    'refund_api_refund_allow_no' => 'Not Allow',
    'refund_api_refund_reject_log' => 'Agent {api_name} refund request rejected, product: {product}, host: {host}, reason: API refund not allowed for this product',
];
