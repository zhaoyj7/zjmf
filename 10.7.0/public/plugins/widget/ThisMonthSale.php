...
class ThisMonthSale extends Widget
{
    ...
    public function getData()
    {
        ...
        $thisMonthAmount = TransactionModel::where('create_time', '>=', $start)->where('create_time', '<', $end)->whereNotIn('id', $withdrawtransactionId)->sum('amount');
        ...
        $prevMonthAmount = TransactionModel::where('create_time', '>=', $start)->where('create_time', '<', $end+$datetime)->whereNotIn('id', $withdrawtransactionId)->sum('amount');
