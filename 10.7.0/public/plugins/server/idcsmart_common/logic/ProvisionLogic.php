...
class ProvisionLogic
{
    ...
    public function __call($name, $arguments = []){
        if(isset($this->support[ucfirst($name)])){
            ...
            }else if ($name == 'changeProduct' || $name == 'ChangeProduct'){
                $this->other_params['old_product'] = $arguments[1];
            }
    ...
    protected function execSupportFunc($name, $hostid = 0){
        ...
        if($this->checkAndRequire($module)){
            ...
            if(function_exists($function)){
                ...
                }else if($name == 'ChangeProduct'){
                    $params['old_product'] = $this->other_params['old_product'];
                }
