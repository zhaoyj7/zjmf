...
Route::group(DIR_ADMIN . '/v1',function (){
    ...
    // 周期管理
    Route::put('idcsmart_common/product/:product_id/cycle/:id/status', "\\server\\idcsmart_common\\controller\\admin\\IdcsmartCommonProductController@updateCycleStatus");

    // 级联配置项 - 级联组管理
    Route::put('idcsmart_common/configoption/:configoption_id/cascade/group/:id', "\\server\\idcsmart_common\\controller\\admin\\IdcsmartCommonCascadeGroupController@update");
    Route::delete('idcsmart_common/configoption/:configoption_id/cascade/group/:id', "\\server\\idcsmart_common\\controller\\admin\\IdcsmartCommonCascadeGroupController@delete");

    // 级联配置项 - 级联项管理
    Route::get('idcsmart_common/configoption/:configoption_id/cascade/tree', "\\server\\idcsmart_common\\controller\\admin\\IdcsmartCommonCascadeItemController@tree");
    Route::get('idcsmart_common/configoption/:configoption_id/cascade/item/:id', "\\server\\idcsmart_common\\controller\\admin\\IdcsmartCommonCascadeItemController@index");
    Route::post('idcsmart_common/configoption/:configoption_id/cascade/item', "\\server\\idcsmart_common\\controller\\admin\\IdcsmartCommonCascadeItemController@create");
    Route::put('idcsmart_common/configoption/:configoption_id/cascade/item/:id', "\\server\\idcsmart_common\\controller\\admin\\IdcsmartCommonCascadeItemController@update");
    Route::delete('idcsmart_common/configoption/:configoption_id/cascade/item/:id', "\\server\\idcsmart_common\\controller\\admin\\IdcsmartCommonCascadeItemController@delete");
    Route::put('idcsmart_common/configoption/:configoption_id/cascade/item/:id/order', "\\server\\idcsmart_common\\controller\\admin\\IdcsmartCommonCascadeItemController@updateOrder");

    // 级联配置项 - 级联项价格管理
    Route::get('idcsmart_common/configoption/:configoption_id/cascade/item/:item_id/price', "\\server\\idcsmart_common\\controller\\admin\\IdcsmartCommonCascadeItemController@getPrice");
    Route::post('idcsmart_common/configoption/:configoption_id/cascade/item/:item_id/price', "\\server\\idcsmart_common\\controller\\admin\\IdcsmartCommonCascadeItemController@setPrice");
