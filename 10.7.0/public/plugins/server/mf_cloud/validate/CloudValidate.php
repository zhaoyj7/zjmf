...
class CloudValidate extends Validate
{
	protected $rule = [
        ...
        'format_data_disk'          => 'integer|in:0,1',
        'ip'                        => 'array',
        'ipv6'                      => 'array',
    ];
    ...
    protected $message  =   [
        ...
        'format_data_disk.integer'          => 'mf_cloud_format_data_disk_format_error',
        'format_data_disk.in'               => 'mf_cloud_format_data_disk_format_error',
        'ip.array'                          => 'param_error',
        'ipv6.array'                        => 'param_error',
    ];
    ...
    protected $scene = [
        ...
        'upgrade_ip_num'            => ['id','ip_num','ipv6_num','ip','ipv6'],
    ...
    public function sceneReinstall(){
        return $this->only(['id','password','image_id','port','ssh_key_id','format_data_disk'])
