...
Route::group('console/v1',function (){
	...
	Route::get('mf_cloud/:id/traffic_package', "\\server\\mf_cloud\\controller\\home\\CloudController@trafficPackageList");
	Route::get('mf_cloud/:id/check_refund', "\\server\\mf_cloud\\controller\\home\\CloudController@checkRefund");
...
Route::group(DIR_ADMIN . '/v1',function (){
	...
	Route::put('mf_cloud/duration/default', "\\server\\mf_cloud\\controller\\admin\\DurationController@setDefault");
	...
	Route::put('mf_cloud/config/disk_range_limit', "\\server\\mf_cloud\\controller\\admin\\ConfigController@saveDiskRangeLimitConfig");
	...
	Route::get('mf_cloud/:id/traffic_package', "\\server\\mf_cloud\\controller\\admin\\CloudController@trafficPackageList");

	// 安全组配置管理
	Route::get('mf_cloud/security_group_config', "\\server\\mf_cloud\\controller\\admin\\SecurityGroupConfigController@list");
	Route::post('mf_cloud/security_group_config', "\\server\\mf_cloud\\controller\\admin\\SecurityGroupConfigController@create");
	Route::put('mf_cloud/security_group_config/:id', "\\server\\mf_cloud\\controller\\admin\\SecurityGroupConfigController@update");
	Route::delete('mf_cloud/security_group_config/:id', "\\server\\mf_cloud\\controller\\admin\\SecurityGroupConfigController@delete");
	Route::post('mf_cloud/security_group_config/reset', "\\server\\mf_cloud\\controller\\admin\\SecurityGroupConfigController@reset");
	Route::put('mf_cloud/security_group_config/sort', "\\server\\mf_cloud\\controller\\admin\\SecurityGroupConfigController@sort");
