...
class MfDcim
{
    ...
    {
		return ['display_name'=>'DCIM(自定义配置)', 'version'=>'4.0.0'];
	}
  ...
  `level_discount_memory_renew` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '内存是否应用等级优惠续费(0=关闭,1=开启)',
  ...
  `level_discount_disk_renew` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '硬盘是否应用等级优惠续费(0=关闭,1=开启)',
  `level_discount_bw_upgrade` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '带宽是否应用等级优惠升降级(0=关闭,1=开启)',
  `level_discount_bw_renew` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '带宽是否应用等级优惠续费(0=关闭,1=开启)',
  `level_discount_ip_num_upgrade` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT 'IP是否应用等级优惠升降级(0=关闭,1=开启)',
  `level_discount_ip_num_renew` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT 'IP是否应用等级优惠续费(0=关闭,1=开启)',
  ...
  `level_discount_gpu_renew` tinyint(1) NOT NULL DEFAULT '1' COMMENT '显卡是否应用等级优惠续费(0=关闭,1=开启)',
