...
class Dcim{
	 ...
	 * @param   array $params 请求参数
	 */
	public function exitRescue($params){
		return $this->request('cancellReinstallByServer', $params);
	}
	 ...
	 * @author hh
	 * @version v1
	 * @param   int params.id - DCIMID require
	 */
	public function ipmiVncRestart($params)
	{
		return $this->request('ipmiVncRestart', $params);
	}
