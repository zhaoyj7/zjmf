...
class LimitRuleModel extends Model
{
    ...
    protected $ruleType = ['data_center','model_config','ipv4_num','bw','flow','image'];
    ...
    public function limitRuleDescription($param)
    {
        $desc = [
            ...
            'ipv4_num'          => lang_plugins('mf_dcim_ipv4_num'),
        ...
        $opt = [
            ...
            'neq' => lang_plugins('mf_dcim_limit_rule_neq'),
        ];
