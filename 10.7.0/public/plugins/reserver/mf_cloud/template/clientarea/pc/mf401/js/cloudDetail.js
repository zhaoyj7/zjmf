  ...
  methods: {
    ...
    getIpPrice() {
      ...
      ipPrice({
        ...
        .then(async (res) => {
          ...
          this.ipMoney = (res.data.data.price * 1000 - this.ipCodePrice * 1000 - this.ipDiscountkDisPrice * 1000) / 1000;
      ...
      this.orderTimer = setTimeout(() => {
        ...
        diskPrice(params)
          .then(async (res) => {
            ...
            this.moreDiscountkDisPrice = res.data.data.price_difference_client_level_discount * 1;
            // if (this.isShowLevel) {
            //   await clientLevelAmount({
            //     id: this.product_id,
            //     amount: res.data.data.price,
            ...
            const calculatedPrice = (price * 1000 - this.moreCodePrice * 1000 - this.moreDiscountkDisPrice * 1000) / 1000;
      ...
      this.orderTimer = setTimeout(() => {
        ...
        expanPrice(params)
          .then(async (res) => {
            ...
            this.expansionDiscount = res.data.data.price_difference_client_level_discount * 1;
            // if (this.isShowLevel) {
            ...
            const diskPrice = price * 1 - this.expansionCodePrice * 1 - this.expansionDiscount * 1;
    ...
    async getBsPrice(bol = false) {
      try {
        ...
        this.bsData.moneyDiscount = res.data.data.price_difference_client_level_discount * 1;
        // if (this.isShowLevel) {
        //   await clientLevelAmount({
        //     id: this.product_id,
        //     amount: res.data.data.price,
        ...
        const calculatedPrice = (price * 1000 - this.bsData.codePrice * 1000 - this.bsData.moneyDiscount * 1000) / 1000;
