...
function orderPackge(params) {
  return Axios.get(`/product/${params.product_id}/common_cloud/package`, {
    params,
  });
}
...
function dataCenter(params) {
  return Axios.get(`/product/${params.id}/common_cloud/data_center`, {
    params,
  });
}
// 获取其它设置
function config(params) {
  return Axios.get(`/product/${params.product_id}/common_cloud/config`, {
    params,
  });
}
// 获取可用操作系统
