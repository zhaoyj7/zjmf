...
Route::group('console/v1',function (){
	...
	Route::get('remf_cloud/:id/traffic_package', "\\reserver\\mf_cloud\\controller\\home\\CloudController@trafficPackageList");
	Route::get('remf_cloud/:id/check_refund', "\\reserver\\mf_cloud\\controller\\home\\CloudController@checkRefund");
...
Route::group(DIR_ADMIN . '/v1',function (){
	...
	Route::get('remf_cloud/:id/traffic_package', "\\reserver\\mf_cloud\\controller\\admin\\CloudController@trafficPackageList");
