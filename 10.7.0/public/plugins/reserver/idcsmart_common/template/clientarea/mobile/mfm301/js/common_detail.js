...
const app2 = Vue.createApp({
  ...
  methods: {
    ...
    osSelectGroupChange(e) {
      this.osIcon =
        "/plugins/reserver/idcsmart_common/template/clientarea/mobile/mfm301/img/idcsmart_common/" +
        e[0].id.toLowerCase() +
        ".svg";
    ...
    async getConfig() {
      ...
      try {
        ...
        if (tabVal === "1") {
          ...
          if (!temp || !temp.configoptions) {
            console.error('upgradeList data is invalid:', temp);
            return;
          }
          ...
          if (!this.upgradeList || !Array.isArray(this.upgradeList) || this.upgradeList.length === 0) {
            console.error('upgradeList is invalid or empty:', this.upgradeList);
            return;
          }
