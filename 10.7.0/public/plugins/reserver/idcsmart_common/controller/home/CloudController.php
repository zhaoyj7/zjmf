...
class CloudController
{
	...
	*/
     ...
     * @return  string upgrade_configoptions[].option_type - 配置类型：select下拉单选，multi_select下拉多选，radio点击单选，quantity数量输入，quantity_range数量拖动，yes_no是否，area区域，cascade级联
     ...
     * @return  string upgrade_configoptions[].fee_type - 计费类型
     ...
     * @return  int upgrade_configoptions[].subs[].hidden - 是否隐藏
     * @return  string upgrade_configoptions[].subs[].country - 国家代码
