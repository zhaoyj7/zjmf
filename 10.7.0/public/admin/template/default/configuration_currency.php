      ...
      <div class="box">
        <t-form :data="formData" :rules="rules" :label-width="80" label-align="top" ref="formValidatorStatus"
          ...
          <t-row :gutter="{ xs: 8, sm: 16, md: 24, lg: 32, xl: 32, xxl: 60 }" class="custom-row">
            ...
            <t-col :xs="12" :xl="4" :md="6">
              <t-form-item name="recharge_order_support_refund" :label="lang.recharge_order_support_refund">
                <t-switch size="large" :custom-value="[1,0]" v-model="formData.recharge_order_support_refund"></t-switch>
                <t-icon name="error-circle" size="18"></t-icon>
                <span class="tip">{{lang.recharge_order_support_refund_tip}}</span>
              </t-form-item>
            </t-col>
          </t-row>
          <!-- 充值提示 -->
