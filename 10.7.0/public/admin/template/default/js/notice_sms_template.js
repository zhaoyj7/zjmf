  ...
  window.onload = function () {
    ...
    new Vue({
      ...
      data () {
        return {
          ...
          columns: [
            ...
            {
              colKey: "notice_setting_name",
              title: lang.notice_default_aciton,
              width: 160,
            },
            {
              colKey: "status",
      ...
      computed: {
        calcTitle () {
          return name => {
            return this.allAction.find(item => item.name === name)?.name_lang;
          }
        }
      },
      created () {
      ...
      methods: {
        ...
        createTemplate () {
          ...
          this.formData.notice_setting_name = "";
          this.optType = "create";
        ...
        async updateHandler (row) {
          try {
            ...
            this.formData.notice_setting_name = temp.notice_setting_name;
            this.visible = true;
          } catch (error) { }
        },
        deleteHandler (row) {
