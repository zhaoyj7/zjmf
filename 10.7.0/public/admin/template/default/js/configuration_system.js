      ...
      data () {
        return {
          ...
          formData: {
            ...
            donot_save_client_product_password: 0
          },
          ...
          rules: {
            ...
            www_url: [{ validator: this.urlValidator }],
          },
          // 图片上传相关
      ...
      methods: {
        ...
        async onSubmit ({ validateResult, firstError }) {
          if (validateResult === true) {
            try {
              ...
              temp.admin_logo = temp.admin_logo[0]?.url || "";
        ...
        async getSetting () {
          try {
            ...
            if (res.data.data.admin_logo) {
              this.formData.admin_logo.push({
                url: res.data.data.admin_logo,
              });
            }
          } catch (error) { }
        },
