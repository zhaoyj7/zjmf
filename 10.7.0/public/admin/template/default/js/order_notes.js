      ...
      methods: {
        ...
        async sureDelUser() {
          try {
            ...
            const res = await deleteOrderRecord({
              id: this.delId,
            });
        ...
        async confirmRecord({validateResult, firstError}) {
          if (validateResult === true) {
            try {
              ...
              this.submitLoading = true;
              const res = await addAndUpdateOrderRecord(this.optType, params);
              this.$message.success(res.data.msg);
        ...
        async getRecordsList() {
          try {
            ...
            const res = await getOrderRecordList(this.recordsParams);
