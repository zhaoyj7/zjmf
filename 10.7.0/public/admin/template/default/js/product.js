(function (window, undefined) {
  ...
  window.onload = function () {
    ...
    new Vue({
      ...
      methods: {
        calcHref(row) {
          if (row.agent === 1 && row.mode === "only_api") {
        ...
        copyHandler(row) {
          ...
          this.copyData.firstId = row.product_group_id_first;
        ...
        changeFisrt(row) {
          ...
          this.updataData.description = row.description;
        },
        ...
        changeCopyFirId(val) {
          ...
          this.copyData.product_group_id = "";
        },
