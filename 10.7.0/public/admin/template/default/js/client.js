      ...
      methods: {
        ...
        async getPlugin() {
          try {
            ...
            this.addonArr.includes("ClientCustomField") && this.getCustomField();
        ...
        async getCustomField () {
          try {
            ...
            const temp = res.data.data.list.filter(item => item.status === 1)
              .reduce((all, cur) => {
                all.push({
        ...
        async getClientList() {
          try {
            ...
            if (params.type.indexOf('addon_client_custom_field_') !== -1) {
              params[params.type] = params.keywords;
              delete params.type;
