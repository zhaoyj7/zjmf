const axiosOriginHost = location.origin;
const axiosHostUrl = location.pathname.split("/")[1];
const axiosBaseHost = `${axiosOriginHost}/${axiosHostUrl}/`;
const axiosBaseURL = `/${axiosHostUrl}/v1`;
...
if (location.href.indexOf("login.htm") === -1) {
  if (!localStorage.getItem("backJwt")) {
    location.href = axiosBaseHost + "login.htm";
    throw new Error();
  }
}
    ...
    if (code) {
      switch (code) {
        case 200:
          break;
        case 302:
          location.href = `${axiosBaseURL}/install`;
          break;
        case 307:
          break;
        case 400:
        ...
        case 401: // 未授权:2个小时未操作自动退出登录
          ...
          break;
        case 403:
          location.href = axiosBaseHost + "404.htm";
          break;
        case 404:
          if (location.href.indexOf("404.htm") === -1) {
            location.href = axiosBaseHost + `404.htm?msg=${response.data.msg}`;
          }
          break;
        case 405:
          location.href = axiosBaseHost + "login.htm";
