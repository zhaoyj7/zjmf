      ...
      <div class="common-header top">
        <t-form :data="formData" ref="form" @submit="onSubmit" layout="inline" label-align="left">
          <t-form-item label=" " name="status">
            <t-select v-model="formData.status" :placeholder="lang.task_status" clearable @change="onSubmit">
              <t-option v-for="item in statusOpt" :value="item.value" :label="item.label" :key="item.value">
              </t-option>
            </t-select>
          </t-form-item>
           <t-form-item label=" " name="status">
            <t-select v-model="formData.type" :placeholder="lang.task_type" clearable @change="onSubmit">
              <t-option v-for="item in taskType" :value="item.value" :label="item.label" :key="item.value">
              </t-option>
            </t-select>
          </t-form-item>
